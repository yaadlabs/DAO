...
voteFungibleCurrencySymbol=7038197ba9c25791cf7849d3727c812075f07d29cb4f049eab741400
...
cat << EOF > $tempDir/$BLOCKCHAIN_PREFIX/datums/$prefix/tally-2-fungible.json
{
  "constructor": 0,
  "fields": [
    {
...
cat << EOF > $tempDir/$BLOCKCHAIN_PREFIX/datums/$prefix/vote-1-fungible.json
{
  "constructor": 0,
  "fields": [
    {
